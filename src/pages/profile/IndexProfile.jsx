...
export default function IndexProfile() {
  ...
  return (
    <div className='w-full animate-fade-left px-4 flex rounded-md items-center justify-center flex-col h-auto'>
      <div className=' p-2 m-8 w-full tracking-wider flex items-center justify-between rounded font-bold  bg-base-100'>
        <span>Profil</span>
