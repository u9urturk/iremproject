...
export default function Footer() {
    return (
        <footer className="body-font flex items-center justify-center flex-col">


            <div className="footer w-full flex flex-col  md:flex-row items-center justify-around  bg-base-100 text-neutral-content p-10">
                <nav>
                    <div className="flex title-font font-medium items-center md:justify-start justify-center text-brandPink">
                ...
                <nav className='flex flex-col md:flex-row items-center justify-center'>
                    ...
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        <div className="text-brandPink">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </div>
                        <div className="ml-3 text-brandPink">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                    ...
                    <p className="text-sm text-brandPink sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-base-200 sm:py-2 sm:mt-0 mt-4">© 2023 Iremceyizevi —
                        <a href="https://twitter.com/knyttneve" className="text-brandPink ml-1" rel="noopener noreferrer" target="_blank">@Iremceyizevi</a>
                    </p>


                </nav>
                <nav className="text-sm text-brandPink sm:ml-4 sm:pl-4 mb-8 sm:py-2 sm:mt-0 mt-4">
